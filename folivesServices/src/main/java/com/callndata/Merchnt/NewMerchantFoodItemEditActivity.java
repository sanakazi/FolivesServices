...
public class NewMerchantFoodItemEditActivity extends FragmentActivity {
    ...
    private Bitmap bm;
    static  String id,txt_veg_nvValue,txt_itemtypeValue;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_new_merchant_food_item_edit);
        ...
        String cuisine_name = intent.getStringExtra("cuisine_name");
        String diet_type_name = intent.getStringExtra("diet_type_name");
        String diet_type_value = intent.getStringExtra("diet_type_value");
        String type_name = intent.getStringExtra("type_name");
        String type_value = intent.getStringExtra("type_value");
        String price = intent.getStringExtra("price");
        String pic = intent.getStringExtra("pic");

        Log.w("values passed " , diet_type_value + " , " + type_value);

        etItemName.setText(item_name);
        etdesc.setText(item_description);
        txt_cuisine.setText(cuisine_name);
        txt_veg_nv.setText(diet_type_name);
        txt_veg_nvValue=diet_type_value;
        txt_itemtype.setText(type_name);
        txt_itemtypeValue= type_value;
        etPrice.setText(price);
      Picasso.with(NewMerchantFoodItemEditActivity.this).load(pic).fit().centerCrop()
                .into(imgFoodImg);
        ...
        img_add_item.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new UpdateItemJSON().execute(id,etItemName.getText().toString(),etdesc.getText().toString(),
    ...
    public class GetDropdownsJSON extends AsyncTask<String, Integer, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(NewMerchantFoodItemEditActivity.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            if (status.equals("true")) {
                ...
                Toast.makeText(NewMerchantFoodItemEditActivity.this, "Oops ...Try again later", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    // to add new item
    public class UpdateItemJSON extends AsyncTask<String, Integer, Void> {
        ...
        protected Void doInBackground(String... params) {
            try {
                ...
                Log.w("params ares" ,"id = " + id +  "  item_name=" + item_name +  " , description=" + description+  " , cuisine=" + cuisine
                        +  " , meal_type=" + meal_type+  " , item_type=" + item_type+  " , price=" + price);


                nameValuePairs = new ArrayList<NameValuePair>();
                nameValuePairs.add(new BasicNameValuePair("access_token", AppConstants.ACCESS_TOKEN));
                nameValuePairs.add(new BasicNameValuePair("id", food_file));
                ...
                HttpClient httpclient = new DefaultHttpClient();
                httppost = new HttpPost(AppConstants.MERCHANT_FOOD_ITEM_UPDATE);
        ...
        protected void onPostExecute(Void result) {
            ...
            if (status.equals("true")) {
                Toast.makeText(NewMerchantFoodItemEditActivity.this, "Updated...", Toast.LENGTH_SHORT).show();
         /*       getSupportFragmentManager().beginTransaction().replace(R.id.main_fragment, new NewMerchantFoodItemFragment(), "fragment")
                ...
                Intent i = new Intent(NewMerchantFoodItemEditActivity.this, MerchantMainActivity.class);
    ...
    private void initiatePopUp_cusine() {
        ...
        dialog = new Dialog(NewMerchantFoodItemEditActivity.this);
        ...
        PopupAdapter adapter = new PopupAdapter(NewMerchantFoodItemEditActivity.this, arrCusine);
    ...
    private void initiatePopUp_mealtype() {
        ...
        list_dropdown = (ListView)dialog.findViewById(R.id.list_dropdown);
        PopupAdapter adapter = new PopupAdapter(NewMerchantFoodItemEditActivity.this, arrVegNv);
        list_dropdown.setAdapter(adapter);
    ...
    private void initiatePopUp_itemtype() {
        ...
        list_dropdown = (ListView)dialog.findViewById(R.id.list_dropdown);
        PopupAdapter adapter = new PopupAdapter(NewMerchantFoodItemEditActivity.this, arrItemType);
        list_dropdown.setAdapter(adapter);
    ...
    private void selectImage() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(NewMerchantFoodItemEditActivity.this);
        ...
        try{
            ...
            if (requestCode == 1) {
				...
				/* the user's device may not support cropping */
                    ...
                    Toast toast = Toast.makeText(NewMerchantFoodItemEditActivity.this, errorMessage,
                            Toast.LENGTH_SHORT);
                    toast.show();
                }
    ...
    public void performCrop(Uri picUri) {
        ...
        // respond to users whose devices do not support the crop action
            ...
            Toast toast = Toast.makeText(NewMerchantFoodItemEditActivity.this, errorMessage, Toast.LENGTH_SHORT);
            toast.show();
        }
    }
