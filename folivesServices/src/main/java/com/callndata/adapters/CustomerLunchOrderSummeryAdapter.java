...
public class CustomerLunchOrderSummeryAdapter extends BaseAdapter {
    ...
    public CustomerLunchOrderSummeryAdapter(Context context, ArrayList<CustomerOrderSummeryItem> CustomerOrderSummeryAL, TextView txtTPrice) {
