...
public class CustomerDinnerOrderSummeryAdapter extends BaseAdapter {
    ...
    public CustomerDinnerOrderSummeryAdapter(Context context, ArrayList<CustomerOrderSummeryItem> CustomerOrderSummeryAL, TextView txtTPrice) {
