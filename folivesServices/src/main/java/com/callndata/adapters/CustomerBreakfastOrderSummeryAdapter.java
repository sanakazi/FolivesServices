...
public class CustomerBreakfastOrderSummeryAdapter extends BaseAdapter {
    ...
    public CustomerBreakfastOrderSummeryAdapter(Context context, ArrayList<CustomerOrderSummeryItem> CustomerOrderSummeryAL, TextView txtTPrice) {
