 ...
 */
public class CustomerChefDetailedViewReviewsAdapter extends BaseAdapter {
    ...
    public CustomerChefDetailedViewReviewsAdapter(Context context, ArrayList<CustomerChefReviewsItem> CustomerChefReviewsItemAL) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            Picasso.with(context).load(CustomerChefReviewsItemAL.get(pos).getImage()).into(holder.imgPic);
        } catch (Exception e) {
            e.printStackTrace();
        }
        holder.txtReview.setText(CustomerChefReviewsItemAL.get(pos).getReview());
        holder.txtName.setText(CustomerChefReviewsItemAL.get(pos).getName());
        holder.txtRating.setText(CustomerChefReviewsItemAL.get(pos).getRating());
    ...
    class Holder {
        ...
        ImageView imgPic;
        TextView txtReview, txtName, txtRating, txtDate;
